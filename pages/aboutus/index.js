  ...
  return (
    <MainLayout menuDefault={true}>
      ...
      <Box
        ...
        my={"20px"}
      >
        <HStack dir="rtl" w={"100%"} justifyContent={"space-between"} gap={'25px'} >
          <Stack w={"100%"} display={{ base: 'none', md: 'flex' }} justifyContent={'end'} alignItems={'end'}>
            <Image src="../../bgsubaboutus.png" w={"445px"} h={"445px"} />
          </Stack>
          <VStack w={"100%"} alignItems={{ base: 'center', md: "start" }}>
            <Text fontSize={'33px'} fontWeight={'extrabold'} color={'#3646B3'}>
              درباره پارسا
            </Text>

            <Text w={"500px"} fontSize={"16px"} textAlign={"start"}>
        ...
        <VStack w={'100%'} alignItems={'center'} mb={'20px'} mt={'100px'}>
          <Text fontWeight={'extrabold'} fontSize={'33px'} color={'#3646B3'}>ویژگی‌های پارسا</Text>
          <Text>گروه پارسا در اين زمينه تلاش هايی به عمل آورده است که از جمله آن به موارد زیر  می‌توان اشاره نمود.</Text>
        </VStack>
        <Box bgColor={'#F7F7F7'}>
          <Grid templateColumns={{ base: "repeat(1, 1fr)", md: "repeat(4, 1fr)" }} gap={"20px"} maxW="container.lg" alignItems={"center"}
            justifyContent={"center"}
            // maxW="container.xl"
            mx="auto" py={'50px'} >
            <VStack bgColor={'white'} p={'20px'} borderRadius={'18px'} boxShadow="0px 3px 5.5px 0px #00000029" w={'250px'} h={'216px'}>
            ...
            <VStack bgColor={'white'} p={'20px'} borderRadius={'18px'} boxShadow="0px 3px 5.5px 0px #00000029" w={'250px'} h={'216px'}>
              ...
              <Text align={'justify'} textAlign={'center'}>موتور جستجوی سوالات از تمامی پایگاه‌های پرسش و پاسخ اسلامی</Text>
            </VStack>
            <VStack bgColor={'white'} p={'20px'} borderRadius={'18px'} boxShadow="0px 3px 5.5px 0px #00000029" w={'250px'} h={'216px'}>
              <Box w={'100px'} h={'100px'}>
            ...
            <VStack bgColor={'white'} p={'20px'} borderRadius={'18px'} boxShadow="0px 3px 5.5px 0px #00000029" w={'250px'} h={'216px'}>
              ...
              <Text align={'justify'} textAlign={'center'}>تصحیح غلط های املایی در سوالات، پاسخ‌ها و متن مورد جستجو</Text>
            </VStack>
            <VStack bgColor={'white'} p={'20px'} borderRadius={'18px'} boxShadow="0px 3px 5.5px 0px #00000029" w={'250px'} h={'216px'}>
              <Box w={'100px'} h={'100px'}>
                <svg class="w-36 mx-auto" viewBox="0 0 124 118" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="-2.85205" y="54.9854" width="53.2068" height="53.2068" rx="12.0315" transform="rotate(-45 -2.85205 54.9854)" fill="#3646B3"></rect><rect x="89.3008" y="0.227539" width="34.2705" height="34.2705" rx="17.1353" fill="#29CCCC"></rect><path d="M76.9785 115.959L1.57203 115.959M90.0544 115.959L117.608 115.959M73.9029 96.854L102.662 68.0951C107.246 63.5113 107.246 56.0796 102.662 51.4958L78.6448 27.4788C74.061 22.8951 66.6293 22.8951 62.0455 27.4788L33.2866 56.2377M73.9029 96.854L54.798 115.959M73.9029 96.854L33.2866 56.2377M38.1987 115.959L14.1817 91.9419C9.59796 87.3581 9.59796 79.9264 14.1817 75.3426L33.2866 56.2377" stroke="#29CCCC" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"></path></svg>
              </Box>
              <Text align={'justify'} textAlign={'center'}>یافتن پاسخ سوال از متن خام کتابهای اسلامی</Text>
            </VStack>
            <VStack bgColor={'white'} p={'20px'} borderRadius={'18px'} boxShadow="0px 3px 5.5px 0px #00000029" w={'250px'} h={'216px'}>
              <Box w={'100px'} h={'100px'}>
              ...
              <Text align={'justify'} textAlign={'center'}>سامانه لیبل گذاری دیتا و تولید دیتاست</Text>
            </VStack>
          </Grid>
        </Box>
        <HStack w={'100%'} justifyContent={'center'} my={'40px'} position={'relative'} mt={'55px'} >
          <VStack >
            <Text fontWeight={'extrabold'} fontSize={'33px'} color={'#3646B3'}>تیم پارسا</Text>
            <Text color={'gray'}>گروه پارسا در اين زمينه تلاش هايی به عمل آورده است که از جمله آن به موارد زیر می‌توان اشاره نمود.</Text>
          </VStack>
        </HStack>

        <Grid templateColumns={{ base: "repeat(1, 1fr)", md: "repeat(5, 1fr)" }} gap={"20px"} w={"100%"} mt={'33px'} maxW="container.lg" alignItems={"center"}
          justifyContent={"center"}
          // maxW="container.xl"
          mx="auto">
          <AboutUsCard />

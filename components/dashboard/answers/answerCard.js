...
const AnswerCard = ({ data }) => {
  return (
    <Grid templateColumns='repeat(4, 1fr)' gap={2} height={'170px'} w={'100%'} bgColor={'white'} borderRadius={'10px'}>
        ...
        <Card as={VStack} height={'100%'} w={'100%'} variant={'unstyled'} flexShrink={0} gap={0} padding={'10px'} borderRadius={'10px'}>
          <HStack w={'100%'} alignItems={'start'} >
            <VStack w={'100%'} alignItems={'start'}>
              ...
              <Box display={'flex'} height={'38px'} bgColor={'white'} w={'100%'} alignItems={'center'} p={'8px'} position={'relative'} pr={'10px'} borderRadius={'5px'} bgColor={'#F7F7F7'}>

...
const LikeCard = () => {
  return (
    <Grid templateColumns='repeat(4, 1fr)' gap={2} height={'150px'} w={'100%'}>
      ...
      <GridItem height={'100%'}>
        <Card height={'100%'} w={'100%'} variant={'unstyled'} flexShrink={0} position={'relative'} bgColor={"#F3F3F3"}
        >
          ...
          <HStack w={'100%'} height={'100%'} justifyContent={'space-between'} bgColor={'white'} padding={'16px'} borderRadius={'10px'}>
